...
$app->group('/admin', function () {
    ...
    $this->group('/newsletter', function () {
        $this->get('', [])->setName('admin.newsletter');
        $this->get('/create', [])->setName('admin.newsletter.create');
        $this->post('/send', [])->setName('admin.newsletter.send');
        $this->delete('/{id:[0-9}', [])->setName('admin.newsletter.delete');
    });
});
